...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNotFound(NotValidException ex) {
        log.error("Error on request process ", ex);
        return new ResponseEntity<>(Map.of("errorMessages", List.of(ex.getMessage())), HttpStatus.BAD_REQUEST);
    }
